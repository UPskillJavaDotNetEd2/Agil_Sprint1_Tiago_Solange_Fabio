...
public class Data {
    ...
    public static Data now() {
        ...
        return new Data(currentDate.getYear(), currentDate.getMonthValue(), currentDate.getDayOfMonth());
    }

    public static int calcularAnos(Data data1, Data data2) {
        return Math.abs(data1.getAno() - data2.getAno());
    }
}